...
Para ajudar você a entender o funcionamento do Plug, nosso serviço roda com base em um Whatsapp Web, e abstraímos os métodos permitindo que você manipule via API RestFul.
